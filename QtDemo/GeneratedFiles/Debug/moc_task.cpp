...
QT_MOC_LITERAL(1, 5, 7), // "sendPic"
QT_MOC_LITERAL(2, 13, 0), // ""
QT_MOC_LITERAL(3, 14, 3), // "img"
QT_MOC_LITERAL(4, 18, 8) // "stopPlay"

    },
    "Task\0sendPic\0\0img\0stopPlay"
};
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendPic((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        ...
        {
            typedef void (Task::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Task::sendPic)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Task::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Task.data,
